...
from convert_ETL78 import data
...
history = model.fit_generator(datagen.flow(X_train, Y_train, batch_size=16), samples_per_epoch=X_train.shape[0],
                    nb_epoch=100, validation_data=(X_val, Y_val))	
...
with open("model_hira_46_2.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("model_hira_46_2.h5")
